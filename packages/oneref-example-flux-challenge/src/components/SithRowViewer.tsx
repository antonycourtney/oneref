...
const SithRowViewer = ({currentPlanet, sithRow}: SithRowViewerProps) => {
    ...
    const sithHome = (sith && sith.homeworld) ? `Homeworld: ${sith.homeworld.name}` : ""
    const style = sith && sith.homeworld && currentPlanet && sith.homeworld.id===currentPlanet.id ? {color: 'red'} : {};
    return (
